...
PlayerPk.prototype.pkTexts = function() {
  ...
  var playerOneText = this.playerTwo.occupation + this.playerTwo.name + this.playerTwo.getWeaponMosaic() +
                      '攻击了' + this.playerOne.occupation + this.playerOne.name +','+
                      this.playerOne.name + '受到了' +
                      (this.playerTwo.attack - this.playerOne.getArmorDef()) + '点伤害，' +
                      this.playerOne.name + '剩余生命：' + this.playerOne.hp + '\n';

  var playerTwoText = this.playerOne.occupation + this.playerOne.name + this.playerOne.getWeaponMosaic() +
